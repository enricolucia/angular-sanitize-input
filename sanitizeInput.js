...
var sanitizeInputModule,
  __hasProp = {}.hasOwnProperty;

sanitizeInputModule = angular.module('sanitizeInput', [])
  .provider('sanitizeInputConfig', function() {
    var _defaultOptions;
    _defaultOptions = {};
  ...
  .directive('sanitizeInput', [
    ...
    function(sanitizeInputConfig) {
      ...
      defaultOptions = sanitizeInputConfig.defaultOptions;
        ...
        link: function(scope, elem, attrs, ngModelCtrl) {
          ...
          ngModelCtrl.$parsers.unshift(function(viewVal) {
            ...
            if (isValid(noCommasVal) || !noCommasVal) {
              ngModelCtrl.$setValidity('sanitizeInput', true);
              return noCommasVal;
            } else {
              ngModelCtrl.$setValidity('sanitizeInput', false);
              return void 0;
            }
          });
          ...
          if (options.preventInvalidInput === true) {
            return elem.on('keypress', function(e) {
              if (isNotDigit(e.which) && isNotControlKey(e.which)) {
                ...
                elem.val(String.fromCharCode(e.which));
                return e.preventDefault();
              }
            });
          }
